...
public class PostController {
    ...
    public ResponseEntity<PostDTO> likePost(@PathVariable ("postId") String postId,
     ...
     public ResponseEntity<MessageRespone> deletePost(@PathVariable("postId") String postId, Principal principal){
        postService.deletePost(Long.parseLong(postId), principal);
        return new ResponseEntity<>(new MessageRespone("Post was deleted"), HttpStatus.OK);
     }
}
